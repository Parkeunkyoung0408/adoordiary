  ...
  return (
    <html lang="ko">
      ...
      <body className="h-dvh w-full flex items-center justify-center bg-[var(--bg-app)] transition-colors duration-300 p-0 sm:p-6 overflow-hidden">
        ...
        <div
          id="app-device-frame"
          className="w-full max-w-[402px] h-dvh sm:h-[840px] sm:rounded-[36px] sm:border-[8px] sm:border-[#2d2d32] sm:shadow-[0_20px_50px_rgba(0,0,0,0.18)] bg-[var(--bg-container)] relative overflow-hidden flex flex-col transition-all duration-300"
        >
